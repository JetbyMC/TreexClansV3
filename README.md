...
This plugin offers the user complete freedom; compared to other plugins, you get total control over customization. The
entire frontend of the plugin can be rewritten from scratch using only YAML configurations.

For instance, you can change the `/clan` command to `/team` or anything else. If you don't like the `/clan home`
argument, you can change it to `/clan base` or `/clan house`—in fact, you can modify arguments and even add multiple
aliases for them.
...
You also have complete freedom regarding GUIs; if you’ve used DeluxeMenus before, you’ll quickly figure out how to
create any GUI for any purpose. We use Libb for GUI handling.
Furthermore, you can customize every single message—and it goes beyond simple text changes; you can add sounds, action
bars, effects, titles, commands, and more. Here is a practical example:
